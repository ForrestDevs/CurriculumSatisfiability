# The data you see here uncommented was the maximum amount I was able to run in the docker on a M2 Mac. 
CLASSROOMS = [
    'A1', 'A2', 'A3', 'A4', 'A5', 
]
DAYS = [
...
TIMESLOTS = [
    "8-9:30am", "9:30-11am", "11am-12:30pm", "12:30-2pm",
    #"2-3:30pm", "3:30-5pm", #"5PM-630PM", "630PM-8PM",
]
TERMS = [
    "T-1", "T-2",
]
...
# Repository of Programs with courses. 
